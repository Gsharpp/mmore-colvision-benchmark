...
# on RCP to validate the full pipeline before submitting the full grid.
#
...
#
# This script does NOT submit anything — run it inside an interactive job
...
# Mirrors what scripts/rcp/submit.sh does for the BenchmarkRecord provenance.
